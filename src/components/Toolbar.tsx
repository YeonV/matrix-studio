import { Box, Stack, IconButton, Tooltip, ToggleButtonGroup, ToggleButton, Divider, createSvgIcon } from '@mui/material';
import {
  InfoOutlined, Save, AspectRatio,
  Undo, Redo, Brush,
  CheckBoxOutlineBlank, GridOn,
...
export const Toolbar = (props: ToolbarProps) => {
  const {
    ...
    onLoadEmpty, onLoadSimple, onLoadClick, onExportClick, onResizeClick
  } = props;
  ...
  return (
    <Box sx={{ p: 1, borderBottom: 1, borderColor: 'divider', bgcolor: 'background.paper' }}>
      <Stack direction="row" spacing={1} alignItems="center">
        ...
        <Tooltip title="Load Empty Layout"><IconButton onClick={onLoadEmpty}><CheckBoxOutlineBlank /></IconButton></Tooltip>
        <Tooltip title="Load Simple Layout"><IconButton onClick={onLoadSimple}><GridOn /></IconButton></Tooltip>
        <Divider orientation="vertical" flexItem />
